  ...
  /*  function simuladorTiempoEsperaCliente() {
   ...
   var disponible = 6 
        ...
        //if (k == 0) {
            ...
            console.log("Clientes en los Lotes actualmente: " + lotes.length)
           ...
           // if (lotes.length != 6 && lotes.length < 6){  // Si no está lleno
            ...
            for (var i = 0 ; i < clientesU.length ; i++) {
                    ...
                    if (i < 6 && lotes.length != 6 && lotes.length < 6 && lotes[q] == undefined){
                    lotes[i] = x // guarda el tiempo
                    entran ++;
                    if (entran < 6){
                        disponible = entran
                ...
                console.log("Espacios ocupados: "  + Math.abs(lotes.length ))
                    console.log("Tiempo de los clientes en los Lotes: " + lotes)
